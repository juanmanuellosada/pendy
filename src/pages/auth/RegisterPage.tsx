  ...
  if (success) {
    return (
      <div className="flex min-h-screen items-center justify-center px-4" style={{ backgroundColor: 'var(--bg-secondary)' }}>
        <div className="w-full max-w-md space-y-6 rounded-2xl p-8 text-center shadow-lg" style={{ backgroundColor: 'var(--bg-primary)', border: '1px solid var(--border-primary)' }}>
          <img src="/pendy-logo.png" alt="Pendy" className="mx-auto h-16 w-16 rounded-xl" />
          <h1 className="text-2xl font-bold" style={{ color: 'var(--text-primary)' }}>¡Cuenta creada!</h1>
    ...
    <div className="flex min-h-screen items-center justify-center px-4" style={{ backgroundColor: 'var(--bg-secondary)' }}>
      <div className="w-full max-w-md space-y-8 rounded-2xl p-8 shadow-lg" style={{ backgroundColor: 'var(--bg-primary)', border: '1px solid var(--border-primary)' }}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            <label htmlFor="fullName" className="block text-sm font-medium" style={{ color: 'var(--text-primary)' }}>
              Nombre completo
            </label>
            <input
              id="fullName"
              ...
              style={{
                ...
                borderColor: errors.fullName ? '#EC1E2A' : 'var(--border-primary)',
          ...
          <div>
            ...
            <input
              ...
              style={{
                backgroundColor: 'var(--bg-primary)',
                borderColor: errors.confirmPassword ? '#EC1E2A' : 'var(--border-primary)',
                color: 'var(--text-primary)',
              }}
              placeholder="••••••••"
            />
        ...
        <p className="text-center text-sm" style={{ color: 'var(--text-secondary)' }}>
          ¿Ya tienes cuenta?{' '}
          <Link to="/auth/login" className="font-semibold hover:underline" style={{ color: '#283B56' }}>
            Inicia sesión
          </Link>
        </p>
      </div>
